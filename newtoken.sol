 ...
 */
    ...
    // The test token of the Shiba Enjin ecosystem.
...
contract TESTToken is ERC20, Ownable {
    ...
    address private  burnWallet = address(0x0000000000000000000000000000000000000000); // Null Address
    ...
    address payable public marketingWallet = payable(address(0x0228ceB0C1080B88Dd1e7A06db0D8D08570fcA39)); // Shiba Enjin: Marketing
    ...
    constructor() ERC20("Test Enjin", "TEST2") {
        dividendTracker = new TESTDividendTracker(RewardToken,msg.sender);
        ...
        dividendTracker.excludeFromDividends(address(burnWallet), true);
        dividendTracker.excludeFromDividends(address(dividendTracker), true);
        dividendTracker.excludeFromDividends(address(_uniswapV2Router), true);
        dividendTracker.excludeFromDividends(address(0x000000000000000000000000000000000000dEaD), true); // Dead Wallet
        dividendTracker.excludeFromDividends(address(0xdEAD000000000000000042069420694206942069), true); // Vitalik Buterin's Burn Address
        dividendTracker.excludeFromDividends(address(0x64dF08684C861C0987182a98682C6831796472d2), true); // Shiba Enjin: Deployer
        dividendTracker.excludeFromDividends(address(0x2f03817a04be5a0248C6DB379f1b00860E91282e), true); // Shiba Enjin: Deployer 2
        dividendTracker.excludeFromDividends(address(0x763EA7E92C5E007a70a75871EFb78de943Cc46Fb), true); // Shiba Enjin: Deployer 3
        ...
        excludeFromFees(address(0x64dF08684C861C0987182a98682C6831796472d2), true); // Shiba Enjin: Deployer
        excludeFromFees(address(0x2f03817a04be5a0248C6DB379f1b00860E91282e), true); // Shiba Enjin: Deployer 2
        excludeFromFees(address(0x763EA7E92C5E007a70a75871EFb78de943Cc46Fb), true); // Shiba Enjin: Deployer 3
        ...
        _isExcludedFromMaxTx[address(_uniswapV2Pair)] = true;
        _isExcludedFromMaxTx[address(0x64dF08684C861C0987182a98682C6831796472d2)] = true; // Shiba Enjin: Deployer
        _isExcludedFromMaxTx[address(0x2f03817a04be5a0248C6DB379f1b00860E91282e)] = true; // Shiba Enjin: Deployer 2
        _isExcludedFromMaxTx[address(0x763EA7E92C5E007a70a75871EFb78de943Cc46Fb)] = true; // Shiba Enjin: Deployer 3
        ...
        _isExcludedFromMaxWallet[address(_uniswapV2Pair)] = true;
        _isExcludedFromMaxWallet[address(0x64dF08684C861C0987182a98682C6831796472d2)] = true; // Shiba Enjin: Deployer
        _isExcludedFromMaxWallet[address(0x2f03817a04be5a0248C6DB379f1b00860E91282e)] = true; // Shiba Enjin: Deployer 2
        _isExcludedFromMaxWallet[address(0x763EA7E92C5E007a70a75871EFb78de943Cc46Fb)] = true; // Shiba Enjin: Deployer 3

        _mint(owner(), 1 * 10**6 * (10**18));

        maxTxAmount = 1000000 * (10**18);
        maxWallet = 1000000 * (10**18);
    }

    receive() external payable {}

    function updateRewardToken(address newToken) public onlyOwner {
        TESTDividendTracker newDividendTracker = new TESTDividendTracker(
            newToken,
            msg.sender
        );
        ...
        newDividendTracker.excludeFromDividends(address(marketingWallet), true);
        newDividendTracker.excludeFromDividends(address(burnWallet), true);
    ...
    function claim() external {
     ...
     function claimOldDividend(address tracker) external {
        TESTDividendTracker oldTracker = TESTDividendTracker(tracker);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if((!_isExcludedFromMaxTx[from]) && (!_isExcludedFromMaxTx[to])){
                require(amount <= maxTxAmount,"Amount exceeds the transaction limit.");
            }
            
            if (!automatedMarketMakerPairs[to] && (!_isExcludedFromMaxWallet[to]) && (!_isExcludedFromMaxWallet[from])) {
                require(
                    balanceOf(to) + amount <= maxWallet,
                    "Balance exceeds maximum number of tokens allowed per wallet."
                );
            }
    ...
    function setMaxTx (uint256 amount) external onlyOwner {
        require(amount >= 1000000 * 10**18,"No rug pulling!");
        maxTxAmount = amount;
    }

    function setMaxWallet (uint256 amount) external onlyOwner {
        require(amount >= 1000000 * 10**18, "No greed for you!");
        maxWallet = amount;
    }
...
contract TESTDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(address rewardToken,address _towner)
        DividendPayingToken("Test Enjin Dividend Tracker", "TESTDIV", rewardToken)
    {
